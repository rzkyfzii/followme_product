...
$sql = "SELECT * FROM sanju $whereSql ORDER BY tanggal DESC";
...
$html .= '<h2>Data Stock Barang - Varian: Sanju</h2>';
...
$filename = "stok_sanju_" . str_replace(", ", "_", strtolower($judulLokasi)) . ".pdf";
