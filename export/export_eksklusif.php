...
$sql = "SELECT * FROM eksklusif $whereSql ORDER BY tanggal DESC";
...
$html .= '<h2>Data Stock Barang - Varian: Eksklusif</h2>';
...
$filename = "stok_eksklusif_" . str_replace(", ", "_", strtolower($judulLokasi)) . ".pdf";
