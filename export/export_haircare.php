...
$sql = "SELECT * FROM haircare $whereSql ORDER BY tanggal DESC";
...
$html .= '<h2>Data Stock Barang - Varian: Haircare</h2>';
...
$filename = "stok_haircare_" . str_replace(", ", "_", strtolower($judulLokasi)) . ".pdf";
