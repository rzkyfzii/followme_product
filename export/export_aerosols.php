...
$sql = "SELECT * FROM aerosols $whereSql ORDER BY tanggal DESC";
...
$html .= '<h2>Data Stock Barang - Varian: Aerosols</h2>';
...
$filename = "stok_aerosols_" . str_replace(", ", "_", strtolower($judulLokasi)) . ".pdf";
