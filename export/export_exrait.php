...
$sql = "SELECT * FROM exrait $whereSql ORDER BY tanggal DESC";
...
$html .= '<h2>Data Stock Barang - Varian: Exrait</h2>';
...
$filename = "stok_exrait_" . str_replace(", ", "_", strtolower($judulLokasi)) . ".pdf";
