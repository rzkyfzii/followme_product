        ...
        <form method="POST" class="custom-form">
          ...
          <div class="form-group">
            ...
            <select class="form-control" id="varian" name="varian" onchange="isiKodeBarang()" required>
              ...
              <option value="MEN BODY SPRAY RED">MEN BODY SPRAY RED</option>
              <option value="MEN BODY SPRAY (WHITE)">MEN BODY SPRAY (WHITE)</option>
              <option value="MEN BODY SPRAY (YELLOW)">MEN BODY SPRAY (YELLOW)</option>
              <option value="SENCE BODY SPRAY HAPPY">SENCE BODY SPRAY HAPPY</option>
              <option value="SENCE BODY SPRAY JOYFUL">SENCE BODY SPRAY JOYFUL</option>
              <option value="SENCE BODY SPRAY LOVELY">SENCE BODY SPRAY LOVELY</option>
              <option value="SENCE BODY SPRAY ROMANCE">SENCE BODY SPRAY ROMANCE</option>
            </select>
          </div>
          ...
          <div class="modal-footer p-0 pt-3">
            <button type="submit" name="aerosols" class="btn btn-primary">Simpan</button>
