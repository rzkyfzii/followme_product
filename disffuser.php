    ...
    <main>
        <div class="container-fluid px-4">
            <div class="card mb-4">
              ...
              <form method="GET" action="export/export_disffuser.php" target="_blank" class="mb-0">
                    ...
                    <form method="GET" class="mb-3">
                      ...
                      <table id="datatablesSimple" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            $query = "SELECT * FROM disffuser $finalWhere ORDER BY tanggal DESC";
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <form method="post">
                                                <div class="modal-body">
                                                    ...
                                                    <br>
                                                    <button type="submit" class="btn btn-danger" name="deletedisffuser">Hapus</button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
        ...
        <form method="POST" class="custom-form">
          ...
          <div class="form-group">
            ...
            <select class="form-control" id="varian" name="varian" onchange="isiKodeBarang()" required>
              ...
              <option value="DISFFUSER FLORAL SENSATION">DISFFUSER FLORAL SENSATION</option>
              <option value="DISFFUSER WARM TOBACCO">DISFFUSER WARM TOBACCO</option>
              <option value="DISFFUSER WOODY"> DISFFUSER WOODY</option>
              <option value="DISFFUSER WHITE">DISFFUSER WHITE</option>
              <option value="DISFFUSER BLUE">DISFFUSER BLUE</option>
              <option value="DISFFUSER">DISFFUSER</option>
            </select>
          </div>
          ...
          <div class="modal-footer p-0 pt-3">
            <button type="submit" name="disffuser" class="btn btn-primary">Simpan</button>
