                    ...
                    <form method="GET" class="mb-3">
                      ...
                      <table id="datatablesSimple" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            $query = "SELECT * FROM haircare $finalWhere ORDER BY tanggal DESC";
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <form method="post">
                                                <div class="modal-body">
                                                    ...
                                                    <br>
                                                    <button type="submit" class="btn btn-danger" name="deletehaircare">Hapus</button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
        ...
        <form method="POST" class="custom-form">
          ...
          <div class="form-group">
            ...
            <select class="form-control" id="varian" name="varian" onchange="isiKodeBarang()" required>
              ...
              <option value="HAIR CREAM (BLACK)">HAIR CREAM (BLACK)</option>
              <option value="HAIR CREAM (WHITE)">HAIR CREAM (WHITE)</option>
              <option value="SUPER HARD GEL (PURPLE)">SUPER HARD GEL (PURPLE)</option>
              <option value="SUPER HARD GEL (GREEN FIX)">SUPER HARD GEL (GREEN FIX)</option>
              <option value="SUPER HARD GEL (BLUE)">SUPER HARD GEL (BLUE)</option>
            </select>
          </div>
          ...
          <div class="modal-footer p-0 pt-3">
            <button type="submit" name="haircare" class="btn btn-primary">Simpan</button>
